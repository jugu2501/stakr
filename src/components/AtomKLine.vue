...
export default {
  ...
  methods: {
    ...
    fetchAll() {
      ...
      let st = 'ibc/C140AFD542AE77BD7DCC83F13FDD8C5E5BB8C4929785E6EC2F4C636F98F17901'
      this.fetchPool(803, atom, st)
      // stkAtom
